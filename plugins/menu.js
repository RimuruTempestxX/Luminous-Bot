 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `💬 ${pmenus} All`, rowId: ".? all", description: "Menampilkan Semua CMD BOT"},
	    {title: `🌱 ${pmenus} Rpg`, rowId: ".? rpg", description: "Game Epic Rpg"},
	{title: `✨ ${pmenus} Exp`, rowId: ".? xp", description: "Collection!"},
	{title: `🎮 ${pmenus} Game`, rowId: ".? game", description: "Game Bot"},
	{title: `🧩 ${pmenus} Fun`, rowId: ".? fun", description: "Bersenang-Senang"},
	{title: `🐚 ${pmenus} Kerang`, rowId: ".? kerangajaib", description: "Hidup Seperti Spongebob"},
	{title: `📑 ${pmenus} Quotes`, rowId: ".? quotes", description: "Random Inspirasi"},
	{title: `⛩️ ${pmenus} Anime`, rowId: ".? anime", description: "Otaku"},
	{title: `🔞 ${pmenus} Nsfw`, rowId: ".? nsfw", description: "Orang Mesum"},
	{title: `🌟 ${pmenus} Premium`, rowId: ".? premium", description: "Only premium Users"},
	{title: `🎭 ${pmenus} Anonymous Chats`, rowId: ".? anonymous", description: "Bicara Dengan Orang Tidak Dikenal"},
	{title: `📖 ${pmenus} Al-Quran`, rowId: ".? quran", description: "Bertobat"},
	{title: `🌎 ${pmenus} Internet`, rowId: ".? internet", description: "Cari File diBOT"},
	{title: `📩 ${pmenus} Downloaders`, rowId: ".? downloader", description: "Download File diBOT"},
	{title: `🎨 ${pmenus} Stikers`, rowId: ".? stiker", description: "Buat Sticker diBOT"},
	{title: `✏️ ${pmenus} Nulis`, rowId: ".? nulis", description: "Menulis Instan"},
	...
	{title: `🛠️ ${pmenus} Tools`, rowId: ".? tools", description: "Tools Cerdas"},
...
const listMessage = {
  text: tek,
  footer: '*✉️Note:* Fitur Bot Belum Sepenuhnya Dirilis, Tunggu Beberapa Hari Dan Semua Fitur Botnya Akan Dirilis',
